...
<html>
	...
	<body>
		<div class="container">
			...
			<div id="banner">
				<div style="background: url(img/layer6.png);"></div>
				<div style="background: url(img/layer5.png);"></div>
				<div style="background: url(img/layer4.png);"></div>
				<div style="background: url(img/layer3.png);"></div>
				<div style="background: url(img/layer2.png);"></div>
				<div style="background: url(img/layer1.png);"></div>
			</div>
			<div id="profile" class="profile-cv tatacv">
				<h2>Profile</h2>
				<img class="pp" src="img/pp.jpg">
			...
			<div id="experience" class="Experiences-cv tatacv">
				...
				<div class="edu span2">
					...
					<div>
						<img src="img/logosmp.png">
						<p>SMPN 1 Pangatikan (2013)</p>
					</div>
					<div>
						<img src="img/logosmk.png">
						<p>SMKN 2 Garut - Multimedia (2016)</p>
					</div>
					<div>
						<img src="img/logosttg.png">
						<p>STTGarut - Informatika (2016 - Sekarang)</p>
					</div>
				</div>
				<h3>Careers</h3>
